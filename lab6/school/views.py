...
def signup_view(request):
    ...
    return render(
        request,
        "school/auth_form.html",
        {"form": form, "title": "Create Account", "btn_text": "Register"},
    )
...
def login_view(request):
    ...
    return render(
        request,
        "school/auth_form.html",
        {"form": form, "title": "Login", "btn_text": "Login"},
    )
...
def student_create(request):
    ...
    return render(
        ...
        {"form": form, "title": "Create Student", "btn_text": "Create"},
    )
...
def student_update(request, pk):
    ...
    return render(
        request,
        "school/student_form.html",
        {"form": form, "title": "Edit Student", "btn_text": "Update"},
    )
...
def subject_create(request):
    ...
    return render(
        ...
        {"form": form, "title": "Create Subject", "btn_text": "Create"},
    )
...
def subject_update(request, pk):
    ...
    return render(
        request,
        "school/subject_form.html",
        {"form": form, "title": "Edit Subject", "btn_text": "Update"},
    )
...
def grade_create(request):
    ...
    return render(
        request,
        "school/grade_form.html",
        {"form": form, "title": "Create Grade", "btn_text": "Create"},
    )
...
def grade_update(request, pk):
    ...
    return render(
        request,
        "school/grade_form.html",
        {"form": form, "title": "Edit Grade", "btn_text": "Update"},
    )
